...
public class TextAreaRendererTest extends JFrame {
    ...
    public TextAreaRendererTest() {
        ...
        String test = "The lazy dog jumped \nover the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown fox";
