...
public class TextAreaRendererTest extends JFrame {
    ...
    public TextAreaRendererTest() {
        ...
        table.setRowHeight(5, 30);
        // We put the table into a scrollpane and into a frame
        getContentPane().add(new JScrollPane(table));
        // We then set a few of the cells to our long example text
        String test = "The lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown foxThe lazy dog jumped over the quick brown fox";
