...
class Reflection extends JPanel {
    ...
    private void loadImage() {
        ...
        try {
            ...
            image = ImageIO.read(new File("resources/images/rotunda.jpg"));
        } catch (Exception ex) {

            Logger.getLogger(Reflection.class.getName()).log(Level.WARNING, null, ex);
        }
    }
