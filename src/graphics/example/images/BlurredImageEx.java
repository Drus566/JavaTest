...
class BlurredImage extends JPanel {
    ...
    private void loadImage() {
        ...
        try {
            ...
            mshi = ImageIO.read(new File("resources/images/mushrooms.jpg"));
        } catch (IOException ex) {

            Logger.getLogger(BlurredImage.class.getName()).log(Level.WARNING, null, ex);
        }
    }
